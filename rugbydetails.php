...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    ...
    <title>RUGBY PLAYER DETAILS</title>
</head>
<body>
...
$diff = date_diff(date_create($dateOfBirth), date_create($today));
  ...
  <ul class="list-group list-group-flush">
    ...
    <li class="list-group-item">TRIES:'.$goals.'</li>
    <li class="list-group-item">CARRIES:'.$carries.'</li>
    <li class="list-group-item">TACKLES'.$tackles.'</li>
    <li class="list-group-item">FOULS:'.$fouls.'</li>
    <li class="list-group-item">INJURIES:'.$injuries.'</li>
  </ul>
  <div class="card-footer">
    <a href="rubgyadddetails.php?id='.$id.'" class = "btn btn-secondary"> ADD MATCH PERFOMANCE  </a>
  </div>
</div>
      </div>
    </div>
        ...
        $stmt = $db->runQuery("SELECT * FROM rugbymatchday WHERE shirtnumber = '$shirtnumber'");
$stmt->execute();
while($rows = $stmt->fetch()){
  ...
  <ul class="list-group list-group-flush">
    <li class="list-group-item">TRIES SCORED:'.$tries.'</li>
    <li class="list-group-item">CARRIES:'.$carries.'</li>
    <li class="list-group-item">TACKLES:'.$tackles.'</li>
...
';
    ...
    ?>
      <a href="rugbyplayers.php" class = "btn btn-primary"> VIEW TEAM PLAYERS </a>
</body>
</html>