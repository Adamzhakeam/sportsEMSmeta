...
$stmt = $db->runQuery("SELECT * FROM register WHERE id = '$playerid'");
$stmt->execute();
...
<body>
    ...
    if(isset($_POST['submit'])){
        $shirtnumber = '';
         $tackles = $tries = $carries = $versingteam = $fouls = $shirtnumber='';
        ...
        $INSERT = $db->runQuery("INSERT INTO rugbymatchday (carries, shirtnumber, tries,tackles, fouls, versingteam)
                                                    VALUES('$carries','$shirtnumber','$tries','$tackles','$fouls','$versingteam')");
        $INSERT->execute();

        $UPDATE = $db->runQuery("UPDATE register  SET carries = carries+'$carries',tries = tries+'$tries' ,tackles = tackles+'$tackles', fouls = '$fouls' WHERE shirtnumber = '$shirtnumber'");
        $UPDATE->execute();
    ...
    <form action="" method="post">
        ...
        <div class="form-group col-md-4">
         ...
         <input class="form-control" type="number" name="tries">
         </div>

         <div class="form-group col-md-4">
         <label for="">TACKLES</label>
         <input class="form-control" type="number" name="tackles">
         </div>
         <div class="form-group col-md-4">
         <label for="">CARRIES</label>
         <input class="form-control" type="number" name="carries">
         </div>
    ...
    <br>
         ...
         <a href="rugbyplayers.php?id=''"  class="btn btn-primary">BACK</a>
